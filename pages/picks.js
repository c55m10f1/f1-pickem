    ...
    <Layout session={session} player={player}>
      <div className="fade-up">
        <div className="mb-5">
          ...
          <div className="text-sm text-[#aaa] mt-1">Picks lock automatically at qualifying time. You can't change picks after that.</div>
        </div>
        ...
        <Card className="mb-4">
          ...
          {readonly ? (
            <div className="bg-[#111118] border border-[#1e1e2c] rounded-lg p-4">
              ...
              {!existing ? (
                <div className="text-[#bbb] text-sm">No pick submitted for this race.</div>
              ) : existing.dns ? (
            ...
            <>
              ...
              <div className="text-xs mt-2" style={{color:'#aaa',fontFamily:"'JetBrains Mono',monospace"}}>
        ...
        {!hasResult && (
          <Card className="mb-4">
            <div className="flex justify-between items-center mb-3">
              <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:"0.8rem",letterSpacing:"2px",color:"#aaa"}}>
                AI RACE ODDS
              </div>
              <span style={{fontSize:"0.6rem",color:"#999",letterSpacing:"1px",fontFamily:"'JetBrains Mono',monospace"}}>
                powered by claude
              </span>
            </div>
            ...
            {!aiOdds && !aiLoading && (
              <div className="flex flex-col gap-2">
                <div style={{color:"#bbb",fontSize:"0.75rem",fontFamily:"'JetBrains Mono',monospace",marginBottom:"8px"}}>
            ...
            {aiOdds && (
              <div>
                  ...
                  {aiOdds.map((d, i) => (
                    <div key={d.driver} className="flex items-center gap-2">
                      <div style={{
                        ...
                        color: i === 0 ? '#FFD060' : i === 1 ? '#aaa' : i === 2 ? '#cd7f32' : '#aaa',
                      ...
                      <div style={{
                        ...
                        color:i===0?'#FFD060':'#aaa',width:'36px',textAlign:'right',flexShrink:0
                ...
                <div className="flex items-center justify-between" style={{marginTop:'12px'}}>
                  {aiCachedAt && (
                    <div style={{fontSize:'0.58rem',color:'#999',fontFamily:"'JetBrains Mono',monospace"}}>
                      updated {new Date(aiCachedAt).toLocaleTimeString('en-US',{hour:'numeric',minute:'2-digit'})}
                    </div>
                  )}
                  <button onClick={() => fetchAiOdds(true)}
                    style={{marginLeft:'auto',background:'none',border:'none',color:'#aaa',
        ...
        {(isLocked || hasResult) && (
          <Card className="mb-4">
            <div className="flex justify-between items-center mb-4">
              ...
              <div style={{fontSize:"0.6rem",color:"#999",letterSpacing:"1px",fontFamily:"'JetBrains Mono',monospace"}}>
                  ...
                  <div key={p.id} style={{
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      <div style={{
                        ...
                        {p.name.toUpperCase()}
                        {isMe && <span style={{fontSize:"0.55rem",marginLeft:"6px",color:"#bbb"}}>YOU</span>}
                      </div>
                      {pk?.is_autopick && (
                    ...
                    {!pk || pk.dns ? (
                      <div style={{fontSize:"0.7rem",color:"#aaa",fontFamily:"'JetBrains Mono',monospace"}}>DNS</div>
                    ) : (
            ...
            {!hasResult && (
              <div style={{marginTop:'14px',fontSize:'0.62rem',color:'#999',fontFamily:"'JetBrains Mono',monospace"}}>
        ...
        {/* Season history */}
        <Card>
          <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:"0.8rem",letterSpacing:"2px",color:"#aaa",marginBottom:"14px"}}>SEASON HISTORY</div>
            ...
            {RACES.map(r => {
              ...
              return (
                <div key={r.id} className="grid gap-2 items-center py-2 border-b border-[#111118] text-sm"
                  ...
                  <div className="font-semibold" style={{color: res ? '#ccc' : '#aaa'}}>{r.name}</div>
                  <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:"0.68rem",color:"#bbb"}}>
                  ...
                  <div className="text-right" style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:"1rem",
                    color: sc ? (sc.total >= 8 ? '#FFD060' : sc.total >= 5 ? '#5a9abf' : '#aaa') : '#999'}}>
                    {sc ? sc.total : '—'}
                  </div>
                </div>
              )
